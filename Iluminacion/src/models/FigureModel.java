...
public abstract class FigureModel extends Objeto3D implements IDrawable {
...
// Luz Propiedades
	...
	public void draw(GL2 gl, GLUT glut) {
		...
		// Habilitar y deshabilitar luces
		...
		if (this.isLight()) {
			...
			gl.glLightfv(light.getValue(), GL2.GL_DIFFUSE, CambiarColor.convertToFME(difuseColor), 0);
			gl.glLightfv(light.getValue(), GL2.GL_SPECULAR, CambiarColor.convertToFME(specularColor), 0);
